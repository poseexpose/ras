  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-sm-12 col-xs-12">
        ...
        <c:forEach items="${listRent}" var="r">
          <div class="col-sm-6">
            <div class="property_item heading_space">
              <div class="image">
                <a href="${pageContext.request.contextPath}/rent/queryRentDetail/${r.house.houseID}"><img style="width: 358px;height: 249.81px" src="${pageContext.request.contextPath}/resources/${r.house.pics[0].picSrc}" alt="latest property" class="img-responsive"></a>
                <div class="price clearfix"> 
                  <span class="tag pull-right">￥${r.rentPrice }/月</span>
                </div>
                <span class="tag_t">出租</span> 
                <!-- <span class="tag_l">Featured</span> -->
              </div>
              <div class="proerty_content">
                <div style="width: 358px;height: 97px" class="proerty_text">
                  <h5 class="captlize"><a href="${pageContext.request.contextPath}/rent/queryRentDetail/${r.house.houseID}">
                  ${r.house.houseName }</a></h5>
                  <p>地址:${r.house.houseAddress }</p>
                </div>
                <div class="property_meta transparent"> 
                  <span><i class="icon-select-an-objecto-tool"></i>${r.house.acreage } 平米</span> 
                  <span><i class="icon-bed"></i>${r.houseType.room } 室</span> 
                  <span><i class="icon-safety-shower"></i>${r.houseType.hall } 厅</span>   
                </div>
                <div class="property_meta transparent bottom30">
                  <span><i class="icon-old-television"></i>TV Lounge</span>
                  <span><i class="icon-garage"></i>${r.houseType.toilet } 卫</span>
                  <span></span>
                </div>
                <div class="favroute clearfix">
                  <p class="pull-md-left">${r.dayAgo} 天前 &nbsp; <i class="icon-calendar2"></i></p>
                  <ul class="pull-right">

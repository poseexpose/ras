					...
					<div class="product">
						<div class="col-md-6">
							<div class="image">
								<img id="picMain" style="width: 540px;height: 370px"
									src="${pageContext.request.contextPath }/resources/${sellDetail.house.pics[0].picSrc}" />
								<div style="margin-top: 20px" class="image-more">
									<ul class="row">
										<c:forEach items="${sellDetail.house.pics}" var="p">
						...
						<form action="cartServlet" method="post" id="formId">
							...
							<div class="col-md-6">
								<div class="caption">
									<div class="name">
										<h4>${sellDetail.house.houseName}</h4>
									</div>
									<!-- <div class="info">
										<ul>
											<li>租金</li>
									...
									<div class="well" style="height: 460px; margin-top: 20px">
										<div class="litem fl" style="width: 250px;float: left">
											<dl class="p_phrase cf">
												<dt>房价</dt>
												<dd class="og">
													<strong><span class="f26" style="font-size: 20px;color:orange">${sellDetail.sellPrice }</span>万元</strong>
												</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>参考首付</dt>
												<dd>${sellDetail.firstPaid }</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>房屋单价</dt>
												<dd>${sellDetail.unitPrice}0000/m²</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>房型</dt>
												<dd>${sellDetail.houseType.room}室${ sellDetail.houseType.hall}厅${ sellDetail.houseType.toilet}卫</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>所在小区</dt>
												<dd>
													<a
														href="https://wuhan.anjuke.com/community/view/214131?from=propview"
														target="_blank">${sellDetail.house.houseEstate}</a>
												</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>位置</dt>
												<dd>
													<a href="https://wuhan.anjuke.com/community/wuchanga/"
														target="_blank">${sellDetail.house.houseAddress}</a>
												</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>年代</dt>
												<dd><fmt:formatDate value="${sellDetail.house.bornDate}" pattern="yyyy" />年</dd>
											</dl>
										...
										<div class="ritem fr" style="width: 250px;float: right">
											...
											<dl class="p_phrase cf">
												<dt>装修</dt>
												<dd>${sellDetail.renovation.renovationType }</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>面积</dt>
												<dd>${sellDetail.house.acreage}平米</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>朝向</dt>
												<dd>${sellDetail.orientation}</dd>
											</dl>

											<dl class="p_phrase cf">
												<dt>楼层</dt>
												<dd>${sellDetail.house.curFloor}/${sellDetail.house.totalFloor}</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>发布人</dt>
												<dd>${sellDetail.user.nickname}</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>联系方式</dt>
												<dd>${sellDetail.user.userTel}</dd>
											</dl>
											<dl class="p_phrase cf">
												<dt>发布时间</dt>
												<dd><fmt:formatDate value="${sellDetail.pubTime}" type="date" dateStyle="full"/></dd>
											</dl>
										</div>
									</div>

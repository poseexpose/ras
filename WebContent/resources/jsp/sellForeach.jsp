...
<c:forEach items="${allListSell }" var="as">
			<div class="cbp-item sale" style="width: 360px;height: 503.81px;position: relative;margin-left: 15px;margin-bottom: 20px;">
				<div class="property_item" style="width: 360px;height: 503.81px;">
					<div class="image" style="width: 358px;height: 249.81px;">
						<a href="${pageContext.request.contextPath}/sell/querySellDetail/${as.house.houseID}"><img
							style="height:249.81px "
							src="${pageContext.request.contextPath}/resources/${as.house.pics[0].picSrc}"
							alt="latest property" class="img-responsive"></a>
						<div class="price clearfix">
							<span class="tag pull-right">￥${as.sellPrice }万元</span>
						</div>
						<span class="tag_t">出售</span> <span class="tag_l">Featured</span>
					</div>
					<div class="proerty_content" style="width: 358px;height: 252px;">
						<div class="proerty_text" style="height: 97px">
							<h5 class="captlize">
								<a href="${pageContext.request.contextPath}/sell/querySellDetail/${as.house.houseID}">
								${as.house.houseName }</a>
							</h5>
							<p>地址:${as.house.houseAddress }</p>
						</div>
						<div class="property_meta transparent"> 
                  <span><i class="icon-select-an-objecto-tool"></i>${as.house.acreage } 平米</span> 
                  <span><i class="icon-bed"></i>${as.houseType.room } 室</span> 
                  <span><i class="icon-safety-shower"></i>${as.houseType.hall } 厅</span>   
                </div>
                <div class="property_meta transparent bottom30">
                  <span><i class="icon-old-television"></i>TV Lounge</span>
                  <span><i class="icon-garage"></i>${as.houseType.toilet } 卫</span>
                  <span></span>
                </div>
						<div class="favroute clearfix">
							<p>
								<i class="icon-calendar2"></i>&nbsp;${as.dayAgo} 天前
							</p>
							<ul class="pull-right">

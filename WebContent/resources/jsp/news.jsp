      ...
      <div class="container">
         <div class="row">
            <div class="col-md-3 col-sm-12">
               <div class="logo"><a href="index3.html"><img alt="" src="${pageContext.request.contextPath}/resources/images/logo.png"></a></div>
            </div>
            <!--Info Box-->
         ...
         <div class="row">
            <div class="col-md-12">
               ...
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand sticky_logo" href="index3.html"><img src="${pageContext.request.contextPath}/resources/images/logo-white.png" class="logo" alt=""></a>
               </div>
            ...
            <div class="row">
               <div class="news-1-box clearfix">
                  <div class="col-md-5 col-sm-5 col-xs-12">
                     <div class="image-2">
                        <a href=""><img src="${pageContext.request.contextPath}/resources/images/blog-1.jpg" alt="image" class="img-responsive"></a>
                     </div>
                  </div>
                  <div class="col-md-7 col-sm-7 col-xs-12 padding-left-25">
                     <h3><a href="">Easy your wat to the Global sotck</a></h3>
                     ...
                     <div class="pro-3-link padding-t-20">
                        ...
                        <i>
                        <img alt="arrow" src="${pageContext.request.contextPath}/resources/images/arrowl.png">
                        </i>
                        <span>Contact Me</span>
                        <i>
                        <img alt="arrow" src="${pageContext.request.contextPath}/resources/images/arrowr.png">
                        </i>
                        </a>
                     </div>
                  </div>
               ...
               <div class="news-1-box clearfix">
                  <div class="col-md-5 col-sm-5 col-xs-12">
                     <div class="image-2">
                       <a href=""> <img src="${pageContext.request.contextPath}/resources/images/blog-2.jpg" alt="image"  class="img-responsive"></a>
                     </div>
                  </div>
                  <div class="col-md-7 col-sm-7 col-xs-12 padding-left-25">
                     <h3><a href="">Easy your wat to the Global sotck</a></h3>
                     ...
                     <div class="pro-3-link padding-t-20">
                        <a class="btn-more" href="">
                        <i><img alt="arrow" src="${pageContext.request.contextPath}/resources/images/arrowl.png"></i><span>Contact Me</span><i> <img alt="arrow" src="${pageContext.request.contextPath}/resources/images/arrowr.png"></i>
                        </a>
                     </div>
                  </div>
               </div>
               <div class="news-1-box clearfix">
                     ...
                     <div id="agent-2-slider" class="owl-carousel">
                        <div class="item">
                           <div class="property_item heading_space">
                              <div class="image"><a href=""><img src="${pageContext.request.contextPath}/resources/images/blog-3.jpg" alt="listin" class="img-responsive"></a></div>
                           </div>
                        </div>
                        <div class="item">
                           <div class="property_item heading_space">
                              <div class="image"><a href=""><img src="${pageContext.request.contextPath}/resources/images/blog-4.jpg" alt="listin" class="img-responsive"></a>
                              </div>
                           </div>
                        </div>
                        <div class="item">
                           <div class="property_item heading_space">
                              <div class="image"><a href=""><img src="${pageContext.request.contextPath}/resources/images/blog-5.jpg" alt="listin" class="img-responsive"></a>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-md-7 col-sm-7 col-xs-12 padding-left-25">
                     ...
                     <p class="p-font-15">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis mollis et sem sed sollicitudin. Donec non odio neque. Aliquam hendrerit mi accumsan nec...</p>
                     <div class="pro-3-link padding-t-20">
                        <a class="btn-more" href=""><i><img alt="arrow" src="${pageContext.request.contextPath}/resources/images/arrowl.png"></i><span>Contact Me</span><i><img alt="arrow" src="${pageContext.request.contextPath}/resources/images/arrowr.png"></i>
                        </a>
                     </div>
                  </div>
               </div>
               <div class="news-1-box clearfix">
                  <div class="col-md-5 col-sm-5 col-xs-12">
                     <div class="image-2">
                        <a href=""><img src="${pageContext.request.contextPath}/resources/images/blog-4.jpg" alt="image" class="img-responsive"></a>
                     </div>
                  </div>
                  <div class="col-md-7 col-sm-7 col-xs-12 padding-left-25">
                     <h3><a href="">Easy your wat to the Global sotck</a></h3>
               ...
               <div class="news-1-box clearfix">
                  <div class="col-md-5 col-sm-5 col-xs-12">
                     <div class="image-2">
                        <a href=""><img src="${pageContext.request.contextPath}/resources/images/blog-5.jpg" alt="image" class="img-responsive"></a>
                     </div>
                  </div>
                  <div class="col-md-7 col-sm-7 col-xs-12 padding-left-25">
                     <h3><a href="">Easy your wat to the Global sotck</a></h3>
                     ...
                     <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis mollis et sem sed sollicitudin. Donec non odio neque. Aliquam hendrerit mi accumsan nec...</p>
                     <div class="pro-3-link">
                        <a class="btn-more" href=""><i><img alt="arrow" src="${pageContext.request.contextPath}/resources/images/arrowl.png"></i><span>Contact Me</span><i><img alt="arrow" src="${pageContext.request.contextPath}/resources/images/arrowr.png"></i></a>
                     </div>
                  </div>
               </div>
               <div class="news-1-box clearfix">
                  <div class="col-md-5 col-sm-5 col-xs-12">
                     <div class="image-2">
                        <a href=""><img src="${pageContext.request.contextPath}/resources/images/blog-6.jpg" alt="image" class="img-responsive"></a>
                     </div>
                  </div>
                  <div class="col-md-7 col-sm-7 col-xs-12 padding-left-25">
                     <h3><a href="">Easy your wat to the Global sotck</a></h3>
